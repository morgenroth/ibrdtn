...
public class PeerListLoader extends AsyncTaskLoader<Cursor> {
    
    private Database mDatabase = null;
    private Cursor mData = null;
    private Boolean mObserving = false;

    public PeerListLoader(Context context, Database database) {
        super(context);
        mDatabase = database;
    }
    ...
    public Cursor loadInBackground() {
        // load all buddies
        return mDatabase.db.query(Database.PEER_TABLE, PeerAdapter.PROJECTION,
    ...
    protected void onStartLoading() {
        ...
        IntentFilter filter = new IntentFilter(Database.NOTIFY_PEERS_CHANGED);
    ...
    private BroadcastReceiver _receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (Database.NOTIFY_PEERS_CHANGED.equals(intent.getAction())) {
                onContentChanged();
            }
        }
    };
