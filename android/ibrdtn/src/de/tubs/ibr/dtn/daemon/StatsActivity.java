...
public class StatsActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabHost.addTab(mTabHost.newTabSpec("storage").setIndicator(getString(R.string.stats_tab_storage)),
                StorageChartFragment.class, null);
        ...
        if (PreferenceManager.getDefaultSharedPreferences(this).getString("timesync_mode", "disabled").equals("slave")) {
