...
public class PlainDeserializer implements SABHandler {
	...
	public interface Callback {
		/**
		 * This method is called, when block data arrives.
		 * The Callback can either provide an OutputStream to write the data to
		 * or throw a SkipDataException if the data should be skipped
		...
		/**
		 * Returns a Block.Data object that encapsulates the data read
		 * into the OutputStream that was returned by the last call to
		 * getBlockDataOutputStream().
