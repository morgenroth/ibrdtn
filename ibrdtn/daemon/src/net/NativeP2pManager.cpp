...
namespace dtn
{
	namespace net
	{
		...
		{
			// create a p2p uri for the discovered node
			const dtn::core::Node::URI uri(dtn::core::Node::NODE_CONNECTED, getProtocol(), identifier, 0, 0);
		...
		{
			// create a p2p uri for the discovered node
			const dtn::core::Node::URI uri(dtn::core::Node::NODE_CONNECTED, getProtocol(), identifier, timeout, priority);
