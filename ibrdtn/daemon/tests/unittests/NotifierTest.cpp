...
void NotifierTest::testRaiseEvent()
{
	/* test signature (const dtn::core::Event *evt) */
	CPPUNIT_FAIL("not implemented");
}

void NotifierTest::testNotify()
{
	/* test signature (std::string title, std::string msg) */
	CPPUNIT_FAIL("not implemented");
}

/*=== END   tests for class 'Notifier' ===*/

void NotifierTest::setUp()
{
}

void NotifierTest::tearDown()
{
}
