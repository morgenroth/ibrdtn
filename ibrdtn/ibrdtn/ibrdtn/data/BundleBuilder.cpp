...
namespace dtn
{
	namespace data
	{
		...
		dtn::data::Block &BundleBuilder::insert(dtn::data::ExtensionBlock::Factory &f, const Bitset &procflags)
		{
			switch (_alignment)
			{
			case FRONT:
		...
		dtn::data::Block& BundleBuilder::insert(dtn::data::block_t block_type, const Bitset &procflags) throw (DiscardBlockException)
		{
