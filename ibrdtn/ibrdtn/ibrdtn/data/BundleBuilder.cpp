...
namespace dtn
{
	namespace data
	{
		...
		dtn::data::Block &BundleBuilder::insert(dtn::data::ExtensionBlock::Factory &f, uint64_t procflags)
		{
			switch (_alignment)
			{
			case FRONT:
		...
		dtn::data::Block& BundleBuilder::insert(dtn::data::block_t block_type, uint64_t procflags) throw (DiscardBlockException)
		{
